...
async function fetchOrders() {
  ...
  try {
    ...
    error.value = e?.response?.data?.message || 'Không thể tải danh sách đơn hàng';
  } finally {
    loading.value = false;
  }
}
      ...
      <div class="max-w-7xl mx-auto px-4 py-4">
        <div class="flex items-center gap-2 text-sm text-gray-600">
          <button
            ...
            class="hover:text-red-600 flex items-center gap-1"
          >
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
      <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
          <div
            v-if="orders.length"
            class="flex items-center gap-2 bg-white rounded-lg shadow px-4 py-2 text-sm text-gray-700"
          >
      ...
      <div v-if="loading" class="space-y-4">
        <div
          v-for="i in 3"
          :key="i"
          class="bg-white rounded-2xl shadow-md p-5 animate-pulse"
        >
      ...
      <div v-else-if="error" class="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl flex items-start gap-3">
      ...
      <div v-else class="space-y-4">
        <div
          ...
          :key="order.id"
          class="bg-white rounded-2xl shadow-md p-5 border border-gray-100 hover:shadow-lg transition"
        >
